...
const NavBar = () => {
    return(
        <>
        <motion.div initial={{y:'900px'}} animate={{y:'0'}} transition={{duration:'2', type:'spring'}} className="font-[IranSans] my-9 bg-white w-[90%] mx-auto p-3 shadow-black shadow-sm rounded-md flex justify-between">
