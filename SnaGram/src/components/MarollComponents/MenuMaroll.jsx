...
const MenuMaroll = () => {
    return(
        <>
         ...
         <motion.div initial={{y:'-900px'}} animate={{y:'0'}} transition={{duration:'2', type:'spring'}} className=" bg-white dark:bg-black dark:shadow-sm dark:shadow-white w-[90%] font-[IranSans] overflow-x-auto whitespace-nowrap border-t-2 border-green-700 rounded-md p-3 mx-auto m-2 text-[.9rem]">
            
                <div className="flex dark:text-white justify-between font-semibold gap-5">
